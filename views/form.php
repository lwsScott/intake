...
<div class="w3-content pageStyle">
    ...
    <div class="w3-white band shadow-lg p-3 mb-5 bg-white rounded" id="form">
        <div class="w3-container w3-content w3-padding-64" id="applicationContainer">
            ...
            <form id="application" method="post" action="confirmation" enctype="multipart/form-data">
                <div id="formSubmission">
                    ...
                    <div class="form-row">
                        ...
                        <img class="w3-hide-medium w3-hide-small" src="{{@BASE}}/images/stjameslogo.png" alt="St. James logo"
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="{{@BASE}}/scripts/form.js"></script>
</body>
</html>