    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myTogglerNav">
            <div class="navbar-nav">
                ...
                <a href="resources" class="nav-item nav-link active">RESOURCES</a>
            </div>
        </div>
    </div>
</nav> <!-- Navbar End -->
        ...
        <div class="container">
            ...
            <div class="row text-left">
                <div class="card mb-5 col-md-8 mx-auto">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{@BASE}}/images/211-logo.png" class="card-img" alt="211 Logo">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="row text-left">
                <div class="card mb-5 col-md-8 mx-auto">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{@BASE}}/images/KentUMC-logo.png" class="card-img" alt="Kent Methodist Logo">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="row text-left">
                <div class="card mb-5 col-md-8 mx-auto">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{@BASE}}/images/dshs.png" class="card-img" alt="DSHS Logo">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="row text-left">
                <div class="card mb-5 col-md-8 mx-auto">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{@BASE}}/images/stjameslogo.png" class="card-img" alt="St. James Logo">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
